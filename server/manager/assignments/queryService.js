...
const saveAssignment = () =>
  `INSERT INTO public.assignments (homework_url, course_id, title, end_date, moodle_id, information) 
        VALUES ($1, $2, $3, $4, $5, $6) RETURNING id`;

const editAssignment = id =>
  `UPDATE public.assignments SET (homework_url, course_id, title, end_date, moodle_id, information)
     = ($1, $2, $3, $4, $5, $6)
  WHERE id = ${id}`;
