    ...
    render() {
        ...
        return (
            <ul className="resourceList">
                ...
                <li><Resource url={this.props.data.lecture} img={this.checkImage(this.props.data.lecture)}>Lecture</Resource></li>
                <li><Resource url={this.props.data.recitation} img={this.checkImage(this.props.data.recitation)}>Recitation</Resource></li>
